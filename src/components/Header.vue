    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <router-link to="/" class="flex items-center gap-2 group">
          <img src="/images/logo.png" alt="MAISON Logo" class="h-40 w-20 object-contain">
          <span class="text-2xl font-bold text-gray-900">MAISON</span>
        </router-link>
        ...
        <div class="hidden md:flex flex-1 mx-8 max-w-md">
          <div class="w-full flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-full hover:shadow-md transition">
            ...
            />
            <button @click="handleSearch" class="text-orange-300 hover:text-orange-600">
        ...
        <nav class="hidden md:flex items-center gap-4">
          ...
          <div v-else class="flex items-center gap-3">
            ...
            <router-link to="/register"
              class="px-4 py-2 bg-orange-300 text-white rounded-full font-medium hover:bg-orange-500 transition">
              S'inscrire
            </router-link>
          </div>
        </nav>
      ...
      <div v-if="isMenuOpen" class="md:hidden pb-4 border-t border-gray-200">
        ...
        <div class="py-3 space-y-2">
          ...
          <button
            @click="handleSearch"
            class="w-full px-4 py-2 bg-orange-300 text-white rounded-lg font-medium hover:bg-orange-600 transition"
          >
            Rechercher
          </button>
        </div>
        ...
        <nav class="space-y-2">
          ...
          <div v-else class="space-y-2">
            ...
            <router-link to="/register" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded">
              S'inscrire
            </router-link>
          </div>
